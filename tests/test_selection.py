...
class TestSelection(unittest.TestCase):
    ...
    def test_stable_across_runs(self):
        ...
        self.assertEqual(verse_index_for_date(dt.date(2026, 1, 1), 1000), 815)
        self.assertEqual(verse_index_for_date(dt.date(2026, 9, 1), 1000), 641)
        self.assertEqual(verse_index_for_date(dt.date(2027, 1, 1), 1000), 987)
